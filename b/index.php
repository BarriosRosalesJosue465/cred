        ...
        <div class="card mb-5">
            ...
            <div class="card-body">
                ...
                <form class="row g-3" action="tambah.php" method="POST">
                    ...
                    <div class="col-md-4">
                        <label for="tittle" class="form-label">email</label>
                        <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step=0.01 name="contacto" class=" form-control" placeholder="contacto" required>
                    </div>
                    ...
                    <form action='edit.php' method='POST'>
                        <div class='modal-body text-start'>
                                ...
                                <div class="col-md-12" id="gender">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label" for="email">
                                            <input class="form-check-input" type="radio" name="edit_email" value="oral" id="cowok">oral</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label" for="email">
                                            <input class="form-check-input" type="radio" name="edit_email" value="topica" id="cewek">topica</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="number" step=0.01 name="edit_contacto" id="edit_contacto" class=" form-control" placeholder="3.52" required>
                            </div>
